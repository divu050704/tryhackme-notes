...
if __name__ == "__main__":
    ...
    # read arg
    encrypted_password = base64.b64decode(bytes('jWbTyS7BL1Hj7PkO5Di/QhhYmcGj5cOoZ2OkDTrFXsR/abAFPM9B3Q==', "utf-8"))
    # decrypt
    passwdXOR = sitelist_xor(encrypted_password)
    password = des3_ecb_decrypt(passwdXOR).decode("utf-8")
    # print out
    print("Crypted password   : %s" % 'jWbTyS7BL1Hj7PkO5Di/QhhYmcGj5cOoZ2OkDTrFXsR/abAFPM9B3Q==')
